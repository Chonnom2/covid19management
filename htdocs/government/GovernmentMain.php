...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><center><button id="btn" onclick="location.href='citizeninfo.php'">국민 정보</button>
      <button id="btn" onclick="location.href='vaccination.php'">국민 백신 접종 여부</button><br><br>
      <button id="btn" onclick="location.href='ivtst.php'">백신 보유 상태</button>
      <button id="btn" onclick="location.href='confirmed.php'">확진자 현황</button></center>
    </div>
    </div>
</html>