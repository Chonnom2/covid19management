...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_plant_search_result.php'>
    <TR>
    <TH>항목</TH><TH colspan='2'>범위(값)</TH>
    </TR>
    <TR><TD><center>공장 코드</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'plant_code'></TD></TD></TR>
    <TR><TD><center>공장 주소</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'address'></TD></TR>
    <TR><TD><center>공장 연락처</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'phone'></TD></TR>
    <TR><TD><center>일일 생산량</TD><TD><center><INPUT TYPE = 'text' NAME = 's_dpc'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_dpc'></TD></TR>
        </TR>
    </TABLE><br>
