...
<div style="position: absolute; top:8%; left:91%;"><button onclick="location.href='moderna_warehouse_add.php'" style="font-size:15px;width:100px;height:45%">창고추가</button></div>
<div style="position: absolute; top:8%; left:82%;"><button onclick="location.href='moderna_warehouse_search.php'" style="font-size:15px;width:100px;height:45%">창고검색</button></div>
<br><br>
<?php
  switch($b)
  {
  ...
  while($row = mysqli_fetch_array($ret)) {
    ...
    echo "<TD><center>", "<a href= 'moderna_warehouse_update.php?warehouse_code=" .$row['warehouse code']. "'>수정</a></TD>";
    echo "<TD><center>", "<a href= 'moderna_warehouse_delete.php?warehouse_code=" .$row['warehouse code']. "'>삭제</a></TD>";
    echo "</TR>";
    $brcount++;
  }
  ...
  if ($page < $total_page) {$next = $page + 1;}
    ...
    echo "<a href='moderna_warehouse_search_result.php?page=1&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&b=$b'> 처음 </a>";
    echo "<a href='moderna_warehouse_search_result.php?page=$pre&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&b=$b'> 이전 </a>";
    for ($i = $block_start; $i <= $block_end; $i++) {
      if($page == $i) {
        echo "</b> $i </b>";
      } 
      else {
        echo "<a href = 'moderna_warehouse_search_result.php?page=$i&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&b=$b'> $i </a>";
        
      }
    }
    echo "<a href='moderna_warehouse_search_result.php?page=$next&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&b=$b'> 다음 </a>";
    echo "<a href='moderna_warehouse_search_result.php?page=$total_page&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&b=$b'> 마지막 </a>";
