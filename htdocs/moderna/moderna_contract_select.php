...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><br><br><center><button id="btn" onclick="location.href='moderna_contract_search.php'">계약 정보 검색/수정</button>
      <button id="btn" onclick="location.href='moderna_contract_view.php'">총 계약정보 확인</button>
      <button id="btn" onclick="location.href='moderna_contract_add.php'">계약 정보 추가</button><br><br>
    </center>
    </div>
    </div>
</html>