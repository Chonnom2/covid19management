...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_warehouse_search_result.php'>
    <TR>
    <TH>항목</TH><TH colspan='2'>범위(값)</TH>
    </TR>
    <TR><TD><center>창고 코드</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'warehouse_code'></TD></TD></TR>
    <TR><TD><center>창고 주소</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'address'></TD></TR>
    <TR><TD><center>창고 연락처</TD><TD colspan = '2'><center><INPUT TYPE = 'text' NAME = 'phone'></TD></TR>
    <TR><TD><center>창고 용량</TD><TD><center><INPUT TYPE = 'text' NAME = 's_capa'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_capa'></TD></TR>
        </TR>
    </TABLE><br>
