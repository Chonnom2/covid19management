...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_plant_add_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
    <TR><TD><center>공장 코드</TD><TD><center><INPUT TYPE = 'text' NAME = 'plant_code'></TD></TR>
    <TR><TD><center>공장 주소</TD><TD><center><INPUT TYPE = 'text' NAME = 'address'></TD></TR>
    <TR><TD><center>공장 연락처</TD><TD><center><INPUT TYPE = 'text' NAME = 'phone'></TD></TR>
    <TR><TD><center>일일 생산량</TD><TD><center><INPUT TYPE = 'text' NAME = 'dpc'></TD></TR>
    </TR>
    </TABLE><br>
