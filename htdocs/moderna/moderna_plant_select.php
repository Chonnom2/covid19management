...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><center><button id="btn" onclick="location.href='moderna_plant_search.php'">공장 정보 검색/수정</button>
      <button id="btn" onclick="location.href='moderna_plant_view.php'">총 공장정보 확인</button><br><br>
      <button id="btn" onclick="location.href='moderna_plant_add.php'">공장 정보 추가</button>
      <button id="btn" onclick="location.href='moderna_plant_running.php'">가동 공장 확인</button>
