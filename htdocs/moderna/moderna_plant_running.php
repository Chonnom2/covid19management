...
?>
<div style="position: absolute; top:8%; left:45%;font-size:25px;width:15%;height:50%;">가동공장 조회 결과</div>
<br><br>
<?php
  ...
  $sql = "SELECT * FROM `moderna_prod` ORDER BY `plant_code` ASC LIMIT $page_start, $list";
  $ret = mysqli_query($con, $sql);
  ...
  echo "<TR>";
  echo "<TH><CENTER>가동중인 공장</CENTER></TH><TH><CENTER>생산 시작 일자</CENTER></TH>";
  echo "</TR></thead>";
  $brcount = 0;
