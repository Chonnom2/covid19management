...
<BODY>
<h1> 생산계획 삭제 </h1>
<FORM METHOD="post" ACTION="moderna_plan_delete_result.php">
    ...
    종료 일자 : <INPUT TYPE = "date" NAME = "fdate" VALUE = <?php echo $fdate?> READONLY> <br>
