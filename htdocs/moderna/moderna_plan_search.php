...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_plan_search_result.php'>
    <TR>
    <TH>항목</TH><TH colspan='2'>범위(값)</TH>
    </TR>
    <TR><TD><center>생산계획 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 's_plan_num'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_plan_num'></TD>
    <TR><TD><center>계약 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 's_connum'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_connum'></TD></TR>
    <TR><TD><center>생산 시작일자</TD><TD><center><INPUT TYPE = 'date' NAME = 's_sdate'></TD><TD><center><INPUT TYPE = 'date' NAME = 'f_sdate'></TD></TR>
    <TR><TD><center>생산 종료일자</TD><TD><center><INPUT TYPE = 'date' NAME = 's_fdate'></TD><TD><center><INPUT TYPE = 'date' NAME = 'f_fdate'></TD></TR>
    <TR><TD><center>수량</TD><TD><center><INPUT TYPE = 'text' NAME = 's_quantity'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_quantity'></TD></TR>
    <TR><TD><center>공장 코드</TD><TD colspan='2'><center><INPUT TYPE = 'text' NAME = 'plantcode'></TD></TR>
    </TR>
    </TABLE><br>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_plan_onesearch_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
    <TR><TD><center>생산계획 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'plan_num'></TD></TR>
    <TR><TD><center>계약 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'connum'></TD></TR>
    <TR><TD><center>생산 시작일자</TD><TD><center><INPUT TYPE = 'date' NAME = 'sdate'></TD></TR>
    <TR><TD><center>생산 종료일자</TD><TD><center><INPUT TYPE = 'date' NAME = 'fdate'></TD></TR>
