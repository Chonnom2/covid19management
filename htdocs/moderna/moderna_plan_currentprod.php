...
?>
<div style="position: absolute; top:7.5%; left:45%;font-size:25px;width:15%;height:50%;">생산현황 조회 결과</div>
<br><br>
<?php
  // 검색어에 따라 다른 튜플 개수 셈(페이징 처리를 위해 필요)
  $sql = "SELECT COUNT(*) FROM `moderna_prod`";
  ...
  $sql = "SELECT * FROM `moderna_prod` ORDER BY `plan num` ASC LIMIT $page_start, $list";
  $ret = mysqli_query($con, $sql);
