...
$connum = $_GET['contract_num'];
$sql = "SELECT * FROM `covid-19`.`contract` WHERE `contract num` = $connum";
...
echo "<TR>";
echo "<TH>계약번호</TH><TH>계약일자</TH><TH>수량</TH><TH>단위 가격</TH><TH>납기 기한</TH><TH>총 금액</TH><TH>수정</TH><TH>삭제</TH>";
echo "</TR>";
$unit = " $";
echo "<TR>";
...
?>
  ...
  <br><br> <center> <input type="button" value="돌아가기" onclick="location.href='moderna_main.php'" style="width:5%;height:50%"/> </center>
</html>