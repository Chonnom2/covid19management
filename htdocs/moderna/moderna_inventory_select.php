...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><br><br><center><button id="btn" onclick="location.href='moderna_inventory_search.php'">재고정보 검색/수정</button>
      <button id="btn" onclick="location.href='moderna_inventory_view.php'">총 재고정보 확인</button>
      <button id="btn" onclick="location.href='moderna_inventory_add.php'">재고 추가</button></center><br><br>
    </div>
    </div>
    ...
    <div>
      ...
      $sql = "SELECT SUM(`quantity`) FROM `covid-19`.`moderna_inventory`";
      ...
      echo "<center><span style = ' font-size:1.5em;'> 보유 백신 수 </span></center><br><br>";
      echo "<CENTER><TABLE border = 1>";
      echo "<TR>";
      echo "<TD><span style = ' font-size:1.25em;'>현재 보유 백신 수</span></TD><TD><span style = ' font-size:1.25em;'>",number_format($num),"</span></TD></TR>";
      ?>
