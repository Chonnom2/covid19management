...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_inventory_search_result.php'>
    <TR>
    <TH>항목</TH><TH colspan='2'>범위(값)</TH>
    </TR>
    <TR><TD><center>재고 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 's_inventory_num'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_inventory_num'></TD>
    <TR><TD><center>로트 번호</TD><TD colspan='2'><center><INPUT TYPE = 'text' NAME = 'lotnum'></TD></TR>
    <TR><TD><center>창고 코드</TD><TD colspan='2'><center><INPUT TYPE = 'text' NAME = 'warehousecode'></TD></TR>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_inventory_onesearch_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
    <TR><TD><center>재고 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'inventory_num'></TD></TR>
    <TR><TD><center>로트 번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'lotnum'></TD></TR>
    <TR><TD><center>창고 코드</TD><TD><center><INPUT TYPE = 'text' NAME = 'warehousecode'></TD></TR>
