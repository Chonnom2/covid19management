...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_inventory_add_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
    <TR><TD><center>재고번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'inventory_num'></TD></TR>
    <TR><TD><center>로트번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'lotnumber'></TD></TR>
    <TR><TD><center>창고코드</TD><TD><center><INPUT TYPE = 'text' NAME = 'warehouse_code'></TD></TR>
