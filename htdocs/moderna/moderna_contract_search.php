...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_contract_search_result.php'>
    <TR>
    <TH>항목</TH><TH colspan='2'>범위(값)</TH>
    </TR>
    <TR><TD><center>계약번호</TD><TD><center><INPUT TYPE = 'text' NAME = 's_contract_num'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_contract_num'></TD>
    <TR><TD><center>계약일자</TD><TD><center><INPUT TYPE = 'date' NAME = 's_date'></TD><TD><center><INPUT TYPE = 'date' NAME = 'f_date'></TD></TR>
    <TR><TD><center>수량</TD><TD><center><INPUT TYPE = 'text' NAME = 's_quantity'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_quantity'></TD></TR>
    <TR><TD><center>단위가격</TD><TD><center><INPUT TYPE = 'text' NAME = 's_uprice'></TD><TD><center><INPUT TYPE = 'text' NAME = 'f_uprice'></TD></TR>
    <TR><TD><center>납기기한</TD><TD><center><INPUT TYPE = 'date' NAME = 's_duedate'></TD><TD><center><INPUT TYPE = 'date' NAME = 'f_duedate'></TD></TR>
    </TR>
    </TABLE><br>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='moderna_contract_onesearch_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
    <TR><TD><center>계약번호</TD><TD><center><INPUT TYPE = 'text' NAME = 'contract_num'></TD></TR>
    <TR><TD><center>계약일자</TD><TD><center><INPUT TYPE = 'date' NAME = 'date'></TD></TR>
    <TR><TD><center>수량</TD><TD><center><INPUT TYPE = 'text' NAME = 'quantity'></TD></TR>
    <TR><TD><center>단위가격</TD><TD><center><INPUT TYPE = 'text' NAME = 'uprice'></TD></TR>
    <TR><TD><center>납기기한</TD><TD><center><INPUT TYPE = 'date' NAME = 'duedate'></TD></TR>
    </TR>
    </TABLE><br>
    <INPUT TYPE = "submit" VALUE = "검색">
    </FORM>
  ...
  <br><br><br><br> <center> <input type="button" value="메인으로" onclick="location.href='moderna_main.php'" style="width:5%;height:50%"/> </center>
</html>
