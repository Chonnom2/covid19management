...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><center><button id="btn" onclick="location.href='moderna_plan_search.php'">생산 계획 검색/수정</button>
      <button id="btn" onclick="location.href='moderna_plan_view.php'">모든 생산계획 확인</button><br><br>
      <button id="btn" onclick="location.href='moderna_plan_add.php'">생산계획 추가</button>
      <button id="btn" onclick="location.href='moderna_plan_currentprod.php'">생산 현황</button></center>
    </div>
    </div>
</html>