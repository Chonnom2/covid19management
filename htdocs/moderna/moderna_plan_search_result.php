...
<?php
  if($j == TRUE)
  {
    $sql = "SELECT * FROM `covid-19`.`moderna_plan` WHERE `plan num` BETWEEN $search_array[0] AND $search_array[1] 
  ...
  if ($page < $total_page) {$next = $page + 1;}
    ...
    echo "<a href='moderna_plan_search_result.php?page=1&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]&arr[]=$search_array[10]&j=$j'> 처음 </a>";
    echo "<a href='moderna_plan_search_result.php?page=$pre&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]&arr[]=$search_array[10]&j=$j'> 이전 </a>";
    for ($i = $block_start; $i <= $block_end; $i++) {
      if($page == $i) {
        echo "</b> $i </b>";
      } 
      else {
        echo "<a href = 'moderna_plan_search_result.php?page=$i&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]&arr[]=$search_array[10]&j=$j'> $i </a>";
        
      }
    }
    echo "<a href='moderna_plan_search_result.php?page=$next&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]&arr[]=$search_array[10]&j=$j'> 다음 </a>";
    echo "<a href='moderna_plan_search_result.php?page=$total_page&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]&arr[]=$search_array[10]&j=$j'> 마지막 </a>";
