...
$plannum = $_GET['plan_num'];
$sql = "SELECT * FROM `covid-19`.`production plan` WHERE `plan num` = $plannum";
$ret = mysqli_query($con, $sql);
$row = mysqli_fetch_array($ret);

echo "<CENTER><TABLE border=1>";
echo "<TR>";
echo "<TH>생산계획 번호</TH><TH>계약 번호</TH><TH>생산 시작 일자</TH><TH>생산 종료 일자</TH><TH>수량</TH><TH>공장 코드</TH><TH>수정</TH><TH>삭제</TH>";
echo "</TR>";
echo "<TR>";
