...
background-color:#39FF14}.header .logo{grid-area:logo;font-size:2rem;font-weight:700;text-decoration:none;color:#fff}.header .nav{grid-area:nav}.header .nav li{display:inline-block;
...
<body>
  ...
  <body>
	<tr>
	<td>
	<FORM METHOD="post"  ACTION="Kinsertinfo.php"><center>
	<table width = "400px" height = "200px">
	<caption><strong> 신규 환자 입력 </strong></caption>
	<tr><th>환자번호  </th> <td><INPUT TYPE ="text" NAME="confirmed_num"></td></tr> <br>
	<tr><th>주민등록번호  </th> <td><INPUT TYPE ="text" NAME="RRN_confirmed"></td></tr> <br>
	<tr><th>병실번호  </th> <td><INPUT TYPE ="text" NAME="room_num"></td></tr> <br>
	<tr><th>입원일  </th> <td><INPUT TYPE ="date" NAME="hospitalization_date"></td></tr> <br>
	<tr><th>증상 </th> <td> <INPUT TYPE ="text" NAME="severity"></td></tr><br>
	<tr><th colspan="2"><INPUT TYPE="submit"  VALUE="환자 입력"></th></tr>
	</FORM></table></center>
	</td>
  </body>
  <br><br> <center> <input type="button" value="이전으로" onclick="location.href='Kconfirmedcase_all.php'" style="width:5%;height:50%"/> </center>
</html>