<?php
   ...
   if(empty($_GET["name"]))
   {
      ...
      {
         echo "정보를 입력해주세요 !! <br><br> <a href='kuh.php'><--초기 화면</a>";
         exit(0);
      }
      else
      {
   ...
   while($row = mysqli_fetch_array($ret)){
      ...
      if($row['severity'] == 3)
         echo "<TD>", "중환자", "</TD>";
      echo "<TD><a href='Kupdateconfirmed.php?RRN_confirmed=".$row['RRN_confirmed']."'>수정</a></TD>";
      echo "<TD><a href='Kdeleteconfirmed.php?RRN_confirmed=".$row['RRN_confirmed']."'>삭제</a></TD>";
      echo"</TR>";
