...
$sql = "SELECT * FROM `hospital room` WHERE `hospital_code`='ynuh'";
...
$sql = "SELECT * FROM `covid-19`.`hospital room` JOIN `covid-19`.`confirmed case` ON `hospital room`.`room num` = `confirmed case`.`room num` WHERE `hospital_code` = 'ynuh'";
