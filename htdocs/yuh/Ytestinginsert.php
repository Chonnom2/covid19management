...
<body>
  ...
  <body>
	<tr>
	<td>
	<FORM METHOD="post"  ACTION="Ytestinginsert_result.php"><center>
	<table width = "400px" height = "200px">
	<caption><strong> 검사 입력 </strong></caption>
	<tr><th>검사번호  </th> <td><INPUT TYPE ="text" NAME="test_num"></td></tr> <br>
	<tr><th>주민등록번호  </th> <td><INPUT TYPE ="text" NAME="RRN_test"></td></tr> <br>
	<tr><th>검사결과  </th> <td><INPUT TYPE ="text" NAME="test_result"></td></tr> <br>
	<tr><th>검사일자  </th> <td><INPUT TYPE ="date" NAME="test_date"></td></tr> <br>
	<tr><th>해외입국여부 </th> <td> <INPUT TYPE ="text" NAME="imported_case"></td></tr><br>
	<tr><th colspan="2"><INPUT TYPE="submit"  VALUE="검사 입력"></th></tr>
	</FORM></table></center>
	</td>
  </body>
  <br><br> <center> <input type="button" value="이전으로" onclick="location.href='Ytesting_all.php'"> </center>
</html>