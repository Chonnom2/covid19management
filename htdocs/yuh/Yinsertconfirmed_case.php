...
<body>
  ...
  <body>
	<tr>
	<td>
	<FORM METHOD="post"  ACTION="Yinsertinfo.php"><center>
  ...
  <br><br> <center> <input type="button" value="이전으로" onclick="location.href='Yconfirmedcase_all.php'" style="width:5%;height:50%"/> </center>
</html>