...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><br><br><center><button id="btn" onclick="location.href='pfizer_inventory_search.php'">재고정보 검색/수정</button>
      <button id="btn" onclick="location.href='pfizer_inventory_view.php'">총 재고정보 확인</button>
      <button id="btn" onclick="location.href='pfizer_inventory_add.php'">재고 추가</button></center><br><br>
    </div>
    </div>
    ...
    <div>
      ...
      $sql = "SELECT SUM(`quantity`) FROM `covid-19`.`pfizer_inventory`";
