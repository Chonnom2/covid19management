...
<body>
  <header class="header">
    ...
    <div class="content">
    <div id = "btn_group">
      <br><br><center><button id="btn" onclick="location.href='pfizer_warehouse_search.php'">창고 정보 검색/수정</button>
      <button id="btn" onclick="location.href='pfizer_warehouse_view.php'">모든 창고정보 확인</button><br><br>
      <button id="btn" onclick="location.href='pfizer_warehouse_add.php'">창고 정보 추가</button>
      <button id="btn" onclick="location.href='pfizer_warehouse_loading.php'">창고 적재 정보</button></center>
    </div>
    </div>
</html>