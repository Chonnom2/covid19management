...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='pfizer_contract_search_result.php'>
    <TR>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='pfizer_contract_onesearch_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
  ...
  <br><br><br><br> <center> <input type="button" value="메인으로" onclick="location.href='pfizer_main.php'" style="width:5%;height:50%"/> </center>
</html>
