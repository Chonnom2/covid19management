...
echo "<TD><center>", "<a href= 'pfizer_warehouse_update.php?lot_num=" .$row['warehouse code']. "'>수정</a></TD>";
echo "<TD><center>", "<a href= 'pfizer_warehouse_delete.php?lot_num=" .$row['warehouse code']. "'>삭제</a></TD>";
echo "</TR>";
mysqli_close($con);
echo "</TABLE><br>";
