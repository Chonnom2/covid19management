...
<body>
  ...
  <body>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='pfizer_plan_search_result.php'>
    <TR>
    ...
    <br><br>
    <CENTER><TABLE border=2><FORM METHOD='post' ACTION='pfizer_plan_onesearch_result.php'>
    <TR>
    <TH>항목</TH><TH>값</TH>
    </TR>
