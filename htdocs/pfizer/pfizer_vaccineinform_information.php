...
echo "<TD><center>", "<a href = 'pfizer_plan_information.php?plan_num=".$row['plan_num']. "'>",$row['plan_num'],"</TD>";
echo "<TD><center>", "<a href = 'pfizer_plant_information.php?plant_code=".$row['prod_plant_code']. "'>",$row['prod_plant_code'],"</TD>";
echo "<TD><center>", "<a href= 'pfizer_vaccineinform_update.php?lot_num=" .$row['lot num']. "'>수정</a></TD>";
echo "<TD><center>", "<a href= 'pfizer_vaccineinform_delete.php?lot_num=" .$row['lot num']. "'>삭제</a></TD>";
echo "</TR>";
mysqli_close($con);
echo "</TABLE><br>";
