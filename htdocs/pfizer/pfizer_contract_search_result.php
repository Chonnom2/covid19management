...
<?php
  ...
  $sql = "SELECT * FROM `covid-19`.`contract` WHERE `contract num` BETWEEN $search_array[0] AND $search_array[1] 
          ...
          AND `unit price` BETWEEN $search_array[6] AND $search_array[7] AND `due date` BETWEEN '$search_array[8]' AND '$search_array[9]'AND `supplies` = '화이자'";
  ...
  if ($page < $total_page) {$next = $page + 1;}
    ...
    echo "<a href='pfizer_contract_search_result.php?page=1&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]'> 처음 </a>";
    echo "<a href='pfizer_contract_search_result.php?page=$pre&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]'> 이전 </a>";
    for ($i = $block_start; $i <= $block_end; $i++) {
      if($page == $i) {
        echo "</b> $i </b>";
      } 
      else {
        echo "<a href = 'pfizer_contract_search_result.php?page=$i&arr[0]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]'> $i </a>";
        
      }
    }
    echo "<a href='pfizer_contract_search_result.php?page=$next&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]'> 다음 </a>";
    echo "<a href='pfizer_contract_search_result.php?page=$total_page&arr[]=$search_array[0]&arr[]=$search_array[1]&arr[]=$search_array[2]&arr[]=$search_array[3]&arr[]=$search_array[4]&arr[]=$search_array[5]&arr[]=$search_array[6]&arr[]=$search_array[7]&arr[]=$search_array[8]&arr[]=$search_array[9]'> 마지막 </a>";
