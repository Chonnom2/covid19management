...
<body>
  ...
  <body>
	<tr>
	<td>
	<FORM METHOD="post"  ACTION="Dinsertinfo.php"><center>
  ...
  <br><br> <center> <input type="button" value="이전으로" onclick="location.href='Dconfirmedcase_all.php'" style="width:5%;height:50%"/> </center>
</html>