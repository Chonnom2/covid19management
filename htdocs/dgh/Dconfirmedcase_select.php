<?php
   ...
   while($row = mysqli_fetch_array($ret)){
      ...
      if($row['severity'] == 3)
         echo "<TD>", "중환자", "</TD>";
      echo "<TD><a href='Dupdateconfirmed.php?RRN_confirmed=".$row['RRN_confirmed']."'>수정</a></TD>";
      echo "<TD><a href='Ddeleteconfirmed.php?RRN_confirmed=".$row['RRN_confirmed']."'>삭제</a></TD>";
      echo"</TR>";
