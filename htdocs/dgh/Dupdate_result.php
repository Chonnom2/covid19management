...
$sql ="select *from `confirmed case`, `hospital room` where '".$_POST['room_num']."' = `hospital room`.`room num` AND `confirmed case`.`confirmed num` = '".$_POST['confirmed_num']."' AND `hospital room`.hospital_code='dgh'";
