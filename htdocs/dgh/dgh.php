...
<body>
  <header class="header">
    ...
    <div id = "btn_group"><center>
      <br><br><br><br><br><br><br><br><button id="btn" onclick="location.href='Dstatistics.php'">현황 통계</button>
      <button id="btn" onclick="location.href='Dtesting_all.php'">검사 정보</button>
      <button id="btn" onclick="location.href='Dconfirmedcase_all.php'">환자 정보</button><br><br>
